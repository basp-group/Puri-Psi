...
struct Params {
  std::string psi_logging_level = "debug";
  std::string name = "";
  std::string weighting = "natural";
  std::string stokes = "I";
  puripsi::casa::MeasurementSet::ChannelWrapper::polarization stokes_val
      = puripsi::casa::MeasurementSet::ChannelWrapper::polarization::I;
  ...
  kernels::kernel kernel = kernels::kernel_from_string.at("kb");
  t_int J = 4;
  t_int width = 512;
  t_int height = 512;
  t_real cellsizex = 0;
  ...
  operators::fftw_plan fftw_plan = operators::fftw_plan::measure;
