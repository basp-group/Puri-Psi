...
TEST_CASE("PuriPsi fitsio", "[readwrite]") {
...
TEST_CASE("readwrite2dheader", "puripsi fitsio") {
  Image<t_complex> input = pfitsio::read2d(image_filename("M31.fits"));
...
TEST_CASE("readwrite3d", "puripsi fitsio") {
...
TEST_CASE("readwrite3dheader", "puripsi fitsio") {
...
TEST_CASE("readwrite3dwith2d", "puripsi fitsio") {
...
TEST_CASE("readwrite3dheaderwith2d", "puripsi fitsio") {
